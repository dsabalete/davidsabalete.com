...
<template>
  <div class="project flex flex-col drop-shadow-2xl">
    ...
    <div class="project-info justify-center">
      ...
      <a :href="project.repo" class="view-project text-blue-700 hover:text-green-900 mr-4" target="_blank">{{
        $t("project_view")
      }}</a>
      <a
        v-if="project.live"
        :href="project.live"
        class="view-demo text-right text-blue-700 hover:text-green-900"
        target="_blank"
        >{{ $t("project_demo") }}</a
      >
    </div>
