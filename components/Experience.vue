    ...
    <section id="experience">
        ...
        <div class="resume-item mb-5">
            <div class="resume-content">
                ...
                <p>
                    ...
                    automated process run on Jenkins) and Testing AB of beta
                    versions before going to upstream. A part of that, I also
                    review code of pull request from different teams, including
                    React code and update, modify or debug Java code in the
        ...
        <div class="resume-item mb-5">
            <div class="resume-content">
                ...
                <p>
                    Implementation of automatic testing with Test Complete and
                    Jenkins in a client-company of the pharmaceutical sector in
                    Parets del Vallès. (01/2017 - 10/2017)
                </p>
                <p>
                    Migration of application to web format, responsive and
                    Single Page Aplication (with AngularJS) for client-company
                    of the banking sector in Sant Cugat del Vallès. (07/2017 -
                    12/2017)
                </p>
            </div>
            <div class="resume-date">
