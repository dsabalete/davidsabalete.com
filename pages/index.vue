...
useSchemaOrg([
  definePerson({
    ...
    image: "https://www.davidsabalete.com/web-profile.webp",
...
<template>
  <div class="page-index sm:mx-auto sm:mt-16 md:ml-40 xl:ml-64">
    <ProfileHeader />
